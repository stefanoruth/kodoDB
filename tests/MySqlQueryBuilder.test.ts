...
describe('MySqlQueryBuilder', () => {
	...
	//     expect(builder.toSql()).toBe('select * from `users` where date(`created_at`) = ?')
	//     expect(builder.getBindings()).toEqual([0 => '2015-12-21'])
	//     builder = getMySqlBuilder();
	...
	//     expect(builder.toSql()).toBe('select * from `users` where day(`created_at`) = ?')
	//     expect(builder.getBindings()).toEqual([0 => 1])
	// }
	// )
	...
	//     expect(builder.getBindings()).toEqual([0 => 1, 1 => 2])
	// }
	// )
	...
	//     expect(builder.toSql()).toBe('select * from `users` where month(`created_at`) = ?')
	//     expect(builder.getBindings()).toEqual([0 => 5])
	// }
	// )
	...
	//     expect(builder.getBindings()).toEqual([0 => 5, 1 => 6])
	// }
	// )
	// test('WhereYearMySql', () => {
	//     builder = getMySqlBuilder();
	...
	//     expect(builder.toSql()).toBe('select * from `users` where year(`created_at`) = ?')
	//     expect(builder.getBindings()).toEqual([0 => 2014])
	// }
	// )
	...
	//     expect(builder.getBindings()).toEqual([0 => 2014, 1 => 2015])
	// }
	// )
	// test('WhereTimeMySql', () => {
	//     builder = getMySqlBuilder();
	...
	//     expect(builder.getBindings()).toEqual([0 => '22:00'])
	// }
	// )
